  ...
  return (
    <>
      ...
      <p className="masthead-motto">
        Изыскание — это научная справка под ваш вопрос о ремесле: как устроен
        несобственно-прямой приём, чем держится ритм абзаца, откуда берётся
        комизм у Довлатова. Это не разбор вашего текста и не проход по
        наставнику — вы спрашиваете, а в ответ приходит справка, которую можно
