...
…
[ГЛАВНОЕ]
<одна главная зона роста фрагмента: куда смотреть в первую очередь — относительно намерения автора, одним абзацем; заверши коучинговым вопросом «какое одно действие сейчас сильнее всего приблизит текст к намерению?»>
[УПРАЖНЕНИЕ]
...
каждую ось завершайте вопросом, который передаёт решение автору. Коучинговый
ориентир — «какое одно действие сейчас сильнее всего приблизит текст к намерению
автора». Отберите приоритетом 2–3 зоны роста, СИЛЬНЕЕ всего отвечающие намерению,
