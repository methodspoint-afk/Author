...
===IRINAOS===
[СЕКЦИЯ: диагноз]
(основной разбор: что происходит в тексте)
[СЕКЦИЯ: беречь]
(душа текста — живые места, которые НЕ нужно трогать: именно они несут голос
автора и силу фрагмента. По возможности процитируйте эти места дословно.)
[СЕКЦИЯ: менять]
(что стоит доработать: направление и вопрос автору. Без готовых формулировок —
решение всегда за автором.)
[СЕКЦИЯ: точка роста]
